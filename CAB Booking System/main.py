...
def feedpage():
    ...
    rebutton=Button(canvas,text="booking page",width=15,fg="white",bg="#92b555",bd=0,font=("Arial",13,'bold'),command=gotocpage)
    canvas.create_window(1200,50,window=rebutton)
    ebutton=Button(canvas,text="Give Review",width=15,fg="white",bg="#92b555",font=("Arial",13,'bold'),command=submitreview)
    canvas.create_window(850,650,window=ebutton)
    canvas.create_text(683,100,text="Feedback" ,fill="White",font=("Arial",30,'bold','underline'))
    canvas.create_text(400,300,text="Rating" ,fill="#fc8230",font=("Arial",25,'bold'))
    canvas.create_text(400,450,text="Review" ,fill="#fc8230",font=("Arial",25,'bold'))
    var = StringVar(root)
    var.set(1)
    secmenu=  ttk.Combobox(root, width=30,height=20,textvariable=var)
    secmenu['values'] =list(range(1,6))
    secmenu['state'] = 'readonly'
    feedEntry=Text(canvas, height=10, width=65,fg='White',bg="#b59f3e",bd=4,font=("Arial",10,'italic'))
...
def cabbook():
    ...
    canvas.create_rectangle(0,0,1366,200,fill="#191919",outline="white")
    canvas.create_rectangle(590,200,890,500,fill="white")
    canvas.create_text(20,30,text="GKV.cabs",fill='white',font=("bauhaus 93",25),anchor=NW)
    canvas.create_text(20,60,text="The best and easiest way to get a cab",fill='white',font=("Lucida calligraphy",15),anchor=NW)
    ...
    bookbutton=Button(canvas,text="book Ride",width=10,fg="white",bg="#088",font=("Arial",13,'bold'),command=book)
    ...
    canvas.pack()
    detbutton=Button(canvas,text="View Past booking",width=15,fg="white",bg="#191919",bd=0,font=("Arial",13,'bold'),command=viewbooking)
    canvas.create_window(1200,90,window=detbutton)
    lobutton=Button(canvas,text="Logout",width=15,fg="white",bg="#191919",bd=0,font=("Arial",13,'bold'),command=loginpage)
    canvas.create_window(1200,180,window=lobutton)
    cpbutton=Button(canvas,text="Change your Password",width=20,fg="white",bg="#191919",bd=0,font=("Arial",13,'bold'),command=changepasswordpage)
    canvas.create_window(1200,110,window=cpbutton)
    revbutton=Button(canvas,text="Review",width=20,fg="white",bg="#191919",bd=0,font=("Arial",13,'bold'),command=feedpage)
...
def adminloginpage():
    ...
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="#000",outline="white")
    canvas.create_text(250,200,text="Admin Login",fill='white',font=("Arial",25,'bold'))
    canvas.create_text(150,300,text="Username",fill='white',font=("Arial",13,'bold'))
    ...
    sbutton=Button(canvas,text="user section",width=10,fg="white",bg="#000",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def loginpage():
    ...
    backgroundIMG=PhotoImage(file="background.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="grey",outline="white")
    ...
    abutton=Button(canvas,text="Admin Login",fg="white",bg="#000",bd=0,font=("Arial",10,'underline'),command=adminloginpage)
